...
public class FileVFSUnitTestCase extends AbstractVFSTest {
    ...
    public void testClassScan() throws Exception {
        ...
        try {
            ...
            super.enableTrace("org.jboss.vfs.SuffixMatchFilter");
    ...
    public void testFileDelete() throws Exception {
        ...
        assertTrue(tmpRoot + ".delete()", root.getPhysicalFile().delete());
        tmpRoot.mkdir();
        ...
        assertFalse(tmpRoot + ".delete() == false", tmpDeletable.getPhysicalFile().delete());
